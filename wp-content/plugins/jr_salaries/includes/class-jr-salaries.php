...
class JR_Salaries {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      JR_Salaries_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
    protected $loader;
  ...
  /**
	 ...
	 *
	 * - JR_Salaries_Loader. Orchestrates the hooks of the plugin.
	 * - JR_Salaries_i18n. Defines internationalization functionality.
	 * - JR_Salaries_Admin. Defines all hooks for the admin area.
	 * - JR_Salaries_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-jr-salaries-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-jr-salaries-i18n.php';
		
		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-jr-salaries-admin.php';
		
		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-jr-salaries-public.php';
		
		$this->loader = new JR_Salaries_Loader();
	}
	 ...
	 *
	 * Uses the JR_Salaries_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		$plugin_i18n = new JR_Salaries_i18n();
  ...
  /**
	...
	private function define_admin_hooks() {
		$plugin_admin = new JR_Salaries_Admin( $this->get_plugin_name(), $this->get_version() );
  ...
  /**
	...
	private function define_public_hooks() {
		$plugin_public = new JR_Salaries_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    JR_Salaries_Loader    Orchestrates the hooks of the plugin.
	 */
